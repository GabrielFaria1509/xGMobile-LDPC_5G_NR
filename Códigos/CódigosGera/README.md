...
| -------- | -------------------------------------------- |
| `A`      | Original transport block size (TBS), in bits |
| `B`      | Transport block size after CRC attachment    |
...
| -------- | ----------------------------------------- |
| `R`      | Target code rate                          |
| `BG`     | LDPC Base Graph number                    |
| `Zc`     | Lifting size used by the LDPC matrix      |
| `H`      | LDPC parity-check matrix                  |
| `K`      | Number of information bits per code block |
...
| Base Graph | Usage                                         |
| ---------- | --------------------------------------------- |
| BG1        | Larger transport blocks and higher code rates |
| BG2        | Smaller transport blocks or lower code rates  |
...
| `SNR_dB` | Signal-to-noise ratio used in channel simulation |
...
| --------- | --------------------------- |
| `message` | Original binary information |
| `R`       | Target coding rate          |
...
| Output | Description              |
| ------ | ------------------------ |
| `rx_1` | Received signal with RV0 |
| `rx_2` | Received signal with RV2 |
| `rx_3` | Received signal with RV3 |
| `rx_4` | Received signal with RV1 |
| `C`    | Number of code blocks    |
| `BG`   | Selected LDPC Base Graph |
| `Zc`   | Lifting size             |
| `B`    | Message size after CRC   |
| `H`    | LDPC parity-check matrix |
...
Implements the circular buffer procedure defined by 3GPP TS 38.212.
...
The output length is controlled by:
...
[
\sigma=\sqrt{\frac{1}{2Q_m10^{SNR/10}}}
]
